...
var indexNav = [
    ...
    {
        name: '光荣榜',
        url: './pages/guangrongbang/list.jsp'
    },
    {
        name: '公告',
    ...
    {
        name: '失物招领',
        url: './pages/shiwuzhaoling/list.jsp'
    },
    {
        name: '物品挂失',
        url: './pages/wupinguashi/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/shiwuzaolinga/jsp/login.jsp";
