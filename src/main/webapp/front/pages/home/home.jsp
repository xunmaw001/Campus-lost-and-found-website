            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right"><img src="../../xznstatic/img/insie1.png" alt="" /></span>
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-right" aos="fade-up-left"><img src="../../xznstatic/img/insie2.png" alt="" /></span>
                            <span class="ng-inmod-the-cn" aos="fade-down">物品挂失展示</span>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div>
                        <div v-for="(item,index) in wupinguashiList" v-bind:key="index" class="col-md-3 col-sm-3 col-xs-6 w3gallery-grids">
                            <div class="imghvr-hinge-right figure" style="width: 100%" @click="jumpCheck('../wupinguashi/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                <img :src="item.wupinguashiPhoto?item.wupinguashiPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                <div class="agile-figcaption">
                                    <h4>{{item.wupinguashiName}}</h4>
                                    <h4 v-if="item.wupinguashiNewMoney">
                                        {{item.wupinguashiNewMoney}} RMB
                                    </h4>
                                    <h4 v-else>
                                        {{item.wupinguashiValue}}
                                    </h4>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right"><img src="../../xznstatic/img/insie1.png" alt="" /></span>
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-right" aos="fade-up-left"><img src="../../xznstatic/img/insie2.png" alt="" /></span>
                            <span class="ng-inmod-the-cn" aos="fade-down">光荣榜展示</span>
                            <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                        </div>
                        <span class="ng-inmod-thebor" aos="fade-up"></span>
                    </div>
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div>
                        <div v-for="(item,index) in guangrongbangList" v-bind:key="index" class="col-md-3 col-sm-3 col-xs-6 w3gallery-grids">
                            <div class="imghvr-hinge-right figure" style="width: 100%" @click="jumpCheck('../guangrongbang/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                <img :src="item.guangrongbangPhoto?item.guangrongbangPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                <div class="agile-figcaption">
                                    <h4>{{item.guangrongbangName}}</h4>
                                    <h4 v-if="item.guangrongbangNewMoney">
                                        {{item.guangrongbangNewMoney}} RMB
                                    </h4>
                                    <h4 v-else>
                                        {{item.guangrongbangValue}}
                                    </h4>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right"><img src="../../xznstatic/img/insie1.png" alt="" /></span>
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-right" aos="fade-up-left"><img src="../../xznstatic/img/insie2.png" alt="" /></span>
                            <span class="ng-inmod-the-cn" aos="fade-down">失物招领展示</span>
                            <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                        </div>
                        <span class="ng-inmod-thebor" aos="fade-up"></span>
                    </div>
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div>
                        <div v-for="(item,index) in shiwuzhaolingList" v-bind:key="index" class="col-md-3 col-sm-3 col-xs-6 w3gallery-grids">
                            <div class="imghvr-hinge-right figure" style="width: 100%" @click="jumpCheck('../shiwuzhaoling/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                <img :src="item.shiwuzhaolingPhoto?item.shiwuzhaolingPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                <div class="agile-figcaption">
                                    <h4>{{item.shiwuzhaolingName}}</h4>
                                    <h4 v-if="item.shiwuzhaolingNewMoney">
                                        {{item.shiwuzhaolingNewMoney}} RMB
                                    </h4>
                                    <h4 v-else>
                                        {{item.shiwuzhaolingValue}}
                                    </h4>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`wupinguashi/list`, 'get', {
            page: 1,
            limit: 8,
        }, function (res) {
            vue.wupinguashiList = res.data.list;
        });
        http.request('guangrongbang/list', 'get', {
            page: 1,
            limit: 8,
        }, function (res) {
            vue.guangrongbangList = res.data.list;
            vue.$nextTick(() => {
                $(".teamb-slide-38").slide({
                    mainCell: ".bd ul",
                    autoPage: true,
        ...
        http.request(`shiwuzhaoling/list`, 'get', {
            ...
            vue.shiwuzhaolingList = res.data.list;
        });
    });
</script>
