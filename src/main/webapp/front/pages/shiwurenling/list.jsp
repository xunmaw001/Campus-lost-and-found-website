            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">失物认领展示</span>
...
<script>
    ...
    // 当前表的字典表
        ...
        function shiwurenlingYesnoTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=shiwurenling_yesno_types", 'get', {}, function (res) {
                if(res.code == 0){
