                        ...
                        <div class="article-list">
                            <ul class="after">
                                <li v-for="(item,index) in dataList" v-bind:key="index">
                                    <a target="_self" :href="'../guangrongbang/detail.jsp?id='+item.id">
                                        <img width="180" class="fl" :src="item.guangrongbangPhoto" />
                                        <h5>{{item.guangrongbangName}}</h5>
                                        <p class="time-sour">
                                            <span>发布时间：{{item.insertTime}} </span>
                                        </p>
                                        <p class="reamk">{{item.guangrongbangContent|subString}}</p>
                                    </a>
                                </li>
                            </ul>
                            <div class="pages">
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            // 获取列表数据
            http.request('guangrongbang/list', 'get', param, function(res) {
