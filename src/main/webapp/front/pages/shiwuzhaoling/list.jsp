                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="shiwuzhaolingName" id="shiwuzhaolingName" placeholder="物品名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-md-3" v-for="(item,index) in dataList" >
                                <div class="galry-grid grid-top-rgt">
                                    <a href="javascript:return false;"  @click="jumpCheck('../shiwuzhaoling/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img class="img-responsive zoom-img" :src="item.shiwuzhaolingPhoto?item.shiwuzhaolingPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                        <div class="w3agile-text">
                                            <h5>
                                                <span>{{item.shiwuzhaolingName}}</span>
                                                <br/>
                                                <span v-if="item.shiwuzhaolingNewMoney">
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#shiwuzhaolingName').val() != null && jquery('#shiwuzhaolingName').val() != "" && jquery('#shiwuzhaolingName').val() != "null" ) {
                param['shiwuzhaolingName'] = jquery('#shiwuzhaolingName').val();
            }
